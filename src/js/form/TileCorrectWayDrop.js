...
export default class TileForm extends React.Component {
  ...
  render() {
    ...
    let bin = [];
    const chartTableType =
      this.props.data.type && this.props.data.type.table
    ...
    if (chartTableType) {
      bin = [
        {
          name: "mappedColumns",
          box: chartTableType.table.columns || []
        },
        {
          name: "sortedColumns",
          box: chartTableType.table.sort || []
        }
      ];
    }
    const dataSet = this.props.data.dataSet.Columns || [];

    //return <Dnd boxes={tableData.dataSet.Columns} bin={bin} />;
                  ...
                  <div className="row">
                    <div className="col-4" style={{ padding: 0 }}>
                      <TabsExampleIconText
                        ...
                        handleHighchartDataChange={
                          this.handleHighchartDataChange
                        }
                        st={this.state}
                      />
                    </div>
...
//import Dnd from "../React DnD/Container";
