...
import customStyle from "../../../../css/react-grid-layout-custom.css";

function getReactGridLayoutFromProps(props) {
  var { children, updateConfigFunc, ...reactGridLayout } = props;
  return reactGridLayout;
}
var connectReactGridLayoutBuilder = ReactGridLayout =>
  class extends Component {
    ...
    onLayoutChange = (currentLayout, allLayouts) => { 
      var reactGridLayout = _.cloneDeep(
        getReactGridLayoutFromProps(this.props)
      );
    ...
    onDragStop = (layout, oldItem, newItem, placeholder, e, element) => {
      ...
      var reactGridLayout = this.updateLayoutIfNecessary(
        layout,
        oldItem,
        newItem,
        placeholder,
    ...
    onLayoutChange = (currentLayout, allLayouts) => {
      var reactGridLayout = _.clone(getReactGridLayoutFromProps(this.props));
      if (this.props.onLayoutChange) {
        this.props.onLayoutChange(reactGridLayout, currentLayout, allLayouts);
      }
      if (reactGridLayout.layouts) {
        reactGridLayout.layouts = allLayouts;
      }
