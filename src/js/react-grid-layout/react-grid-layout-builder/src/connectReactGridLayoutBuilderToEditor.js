...
export var connectReactGridLayoutBuilderToEditor = Editor =>
      ...
      if (event) {
        if (event.target) {
          ...
          switch (id) {
            ...
            reactGridLayout.preventCollision = targetValue;
            break;
            case "allStatic":
              targetValue = event.target.checked;
              reactGridLayout.allStatic = targetValue;
              break;
            case "isDraggable":
              targetValue = event.target.checked;
            ...
            case "cols_xs":
            case "cols_xxs":
              reactGridLayout.cols[id.replace("cols_", "")] = Number(
                targetValue
              );
              break;
            case "rowHeight":
